...
\qitem{Der Stylist der Schauspielerin, die große finanzielle Probleme hatte, trug eine Perücke.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Schauspielerin Schulden hatte?}
\qitem{Der Retter des Verunglückten, der eine schöne Wohnung hatte, bekam eine Auszeichnung.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Retter eine helle Dachterassenwohnung hatte?}
...
\qitem{Die Cousine des Schriftstellers, die eine tragische Vergangenheit hatte, fährt einen BMW.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Cousine eine schlimme Vergangenheit hatte?}
...
\qitem{Die Visagistin des Bürgermeisters, der beeindruckend viel Ehrgeiz hatte, schrieb Gedichte.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Visagistin ehrgeizig war?}
...
\qitem{Der Manager der Künstlerin, der kristallklare blaue Augen hat, ist noch recht unerfahren.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Manager kristallklare blaue Augen hat?}
\qitem{Die Tante der Kassiererin, die ein auffälliges Muttermal hatte, hat das Rauchen aufgegeben.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Kassiererin ein grosses Muttermal hatte?}
\qitem{Der Arzt der Bäuerin, der weithin bekannte Vorfahren hatte, war sehr neugierig.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Bäuerin bekannte Vorfahren hatte?}
...
\qitem{Der Kollege der Detektivin, der einen großen Hund hatte, hatte öfter Probleme mit dem Finanzamt.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Kollege einen großen Hund hatte?}
\qitem{Die Steuerberaterin des Psychologen, der beschämend vernachlässigte Zähne hatte, hat eine Stauballergie.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Psychologe gelbe Zähne hatte?}
\qitem{Der Schneider des Geschäftsmanns, der sehr schwarzen Humor hatte, lachte viel.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Schneider schwarzen Humor mochte?}
...
\qitem{Der Sohn der Forscherin, die schwere gesundheitliche Probleme hatte, spielte gerne Schach.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Forscherin unter gesundheitlichen Problemen litt?}
...
\qitem{Die Vertraute des Richters, der viele gute Einfälle hatte, kannte viele Geheimnisse.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Richter kreativ war?}
\qitem{Die Bedienstete der Gräfin, die extrem laute Kinder hatte, konnte nicht mehr.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Gräfin Kinder hatte?}
\qitem{Der Schwager der Fotografin, die eine beeindruckende Privatbibliothek hatte, lebte in Wien.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Schwager viele Bücher hatte?}
...
\qitem{Der Verleger der Autorin, der einen österreichischen Akzent hatte, hat sich gemeldet.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Autorin wie ein Österreicher sprach?}
\qitem{Der Pfleger der Rentnerin, die eine aufdringliche Art hatte, hat letzten Monat geheiratet.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Pfleger Leuten zu nahe kam?}
...
\qitem{Die Freundin der Tänzerin, die eine unheilbare Krankheit hatte, hört gerne Rockmusik.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Freundin schwer krank war?}
\qitem{Die Assistentin des Zahnarztes, die einen eigenwilligen Haarschnitt hatte, war sehr selbstbewußt.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Zahnarzt einen Irokesen hatte?}
\qitem{Der Angestellte der Bäckerin, der regelmässig starke Hustenanfälle hat, überlegt zu kündigen.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Bäckerin oft hustet?}
\qitem{Der Gärtner des Bankers, der andauernd heftige Migräne hatte, war nicht besonders gesprächig.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Banker Migräne hatte?}
...
\qitem{Die Mentorin des Doktoranden, die zwei kleine Kinder hatte, war kurz vor dem Verzweifeln.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Doktorand Kinder hatte?}
\qitem{Der Konkurrent des Sportlers, der einen ungewöhnlichen Namen hatte, hat sich verletzt.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Sportler komisch hiess?}
\qitem{Der Anwalt des Angeklagten, der kein bisschen Anstand hatte, hat sich verspätet.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Angeklagte hämisch grinste?}
\qitem{Die Schwiegertochter des Gitarristen, der einen ausgezeichneten Geschmack hatte, lachte eigentlich ständig.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Schwiegertochter einen guten Geschmack hatte?}
...
\qitem{Der Reisefüher der Touristin, der eine dicke Hornbrille hatte, bekam ständig Anrufe.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Reisefüher eine Brille trug?}
...
\qitem{Die Trainerin des Athleten, die einen fürchterlichen Schnupfen hatte, verlangte immer maximale Leistung.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Athlet einen Schnupfen hatte?}
...
\qitem{Der Berater der Politikerin, die einen neuen Audi hatte, hat sich bewährt.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Politikerin einen neuen Audi hatte?}
\qitem{Der Agent des Sängers, der einige silbergraue Strähnen hatte, wurde wegen Drogenbesitz festgenommen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Agent silbergraue Strähnen hatte?}
...
\qitem{Die Tutorin des Studenten, die überschäumend gute Laune hatte, hatte die Regelstudienzeit schon langen überschritten.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Tutorin gut gelaunt war?}
\qitem{Die Buchhalterin der Unternehmerin, die viel goldenen Schmuck hat, hat momentan Urlaub.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Buchhalterin viel Goldschmuck hat?}
\qitem{Die Klassenlehrerin der Schülerin, die mehrere langhaarige Hunde hatte, mag ausgefallene Brillen.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Klassenlehrerin Hunde hatte?}
...
\qitem{Die Schwester der Schneiderin, die hübsche schwarze Locken hatte, hat sich verlobt.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Schneiderin lockige Haare hatte?}
...
\qitem{Die Optikerin des Verkäufers, der eine schwerwiegende Depression hatte, wurde überfallen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Verkäufer depressiv war?}
\qitem{Die Patientin des Logopäden, der eine sportliche Figur hatte, spielte sehr gerne Klavier.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Patientin muskulös war?}
...
\qitem{Die Sekretärin des Direktors, die außergewöhnlich grosse Ohren hatte, überlegt sich zu kündigen.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Sekretärin grosse Ohren hatte?}
\qitem{Der Friseur der Regisseurin, die einen ausgezeichneten Ruf hatte, ist unbestimmt verzogen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Friseur respektiert wurde?}
