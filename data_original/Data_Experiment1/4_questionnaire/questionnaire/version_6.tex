...
\qitem{Der Vertraute des Richters, der viele gute Einfälle hatte, kannte viele Geheimnisse.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Richter kreativ war?}
\qitem{Die Managerin des Künstlers, der kristallklare blaue Augen hat, ist noch recht unerfahren.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Managerin kristallklare blaue Augen hat?}
...
\qitem{Der Visagist des Bürgermeisters, der beeindruckend viel Ehrgeiz hatte, schrieb Gedichte.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Visagist ehrgeizig war?}
...
\qitem{Die Stylistin der Schauspielerin, die große finanzielle Probleme hatte, trug eine Perücke.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Schauspielerin Schulden hatte?}
...
\qitem{Der Retter der Verunglückten, der eine schöne Wohnung hatte, bekam eine Auszeichnung.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Retter eine helle Dachterassenwohnung hatte?}
\qitem{Die Beraterin der Politikerin, die einen neuen Audi hatte, hat sich bewährt.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Politikerin einen neuen Audi hatte?}
...
\qitem{Die Freundin des Tänzers, die eine unheilbare Krankheit hatte, hört gerne Rockmusik.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Freundin schwer krank war?}
...
\qitem{Der Assistent der Zahnärztin, die einen eigenwilligen Haarschnitt hatte, war sehr selbstbewußt.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Zahnärztin einen Irokesen hatte?}
\qitem{Die Buchhalterin des Unternehmers, der viel goldenen Schmuck hat, hat momentan Urlaub.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Buchhalterin viel Goldschmuck hat?}
...
\qitem{Die Schwägerin der Fotografin, die eine beeindruckende Privatbibliothek hatte, lebte in Wien.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Schwägerin viele Bücher hatte?}
\qitem{Die Tante des Kassierers, die ein auffälliges Muttermal hatte, hat das Rauchen aufgegeben.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Kassierer ein grosses Muttermal hatte?}
\qitem{Die Verlegerin des Autors, der einen österreichischen Akzent hatte, hat sich gemeldet.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Autor wie ein Österreicher sprach?}
...
\qitem{Die Schwester des Schneiders, die hübsche schwarze Locken hatte, hat sich verlobt.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Schneider lockige Haare hatte?}
...
\qitem{Der Patient des Logopäden, der eine sportliche Figur hatte, spielte sehr gerne Klavier.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Patient muskulös war?}
\qitem{Der Sekretär der Direktorin, die außergewöhnlich grosse Ohren hatte, überlegt sich zu kündigen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Sekretär grosse Ohren hatte?}
...
\qitem{Der Schneider der Geschäftsfrau, der sehr schwarzen Humor hatte, lachte viel.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Schneider schwarzen Humor mochte?}
...
\qitem{Der Anwalt der Angeklagten, der kein bisschen Anstand hatte, hat sich verspätet.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Angeklagte hämisch grinste?}
\qitem{Der Tutor der Studentin, die überschäumend gute Laune hatte, hatte die Regelstudienzeit schon langen überschritten.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Tutor gut gelaunt war?}
...
\qitem{Die Bedienstete des Grafen, die extrem laute Kinder hatte, konnte nicht mehr.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Graf Kinder hatte?}
\qitem{Die Tochter der Forscherin, die schwere gesundheitliche Probleme hatte, spielte gerne Schach.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Forscherin unter gesundheitlichen Problemen litt?}
\qitem{Die Ärztin des Bauern, der weithin bekannte Vorfahren hatte, war sehr neugierig.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Bauer bekannte Vorfahren hatte?}
\qitem{Der Trainer der Athletin, die einen fürchterlichen Schnupfen hatte, verlangte immer maximale Leistung.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Athletin einen Schnupfen hatte?}
...
\qitem{Der Gärtner der Bankerin, der andauernd heftige Migräne hatte, war nicht besonders gesprächig.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Bankerin Migräne hatte?}
\qitem{Die Angestellte des Bäckers, der regelmässig starke Hustenanfälle hat, überlegt zu kündigen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Bäcker oft hustet?}
...
\qitem{Der Schwiegersohn des Gitarristen, der einen ausgezeichneten Geschmack hatte, lachte eigentlich ständig.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Schwiegersohn einen guten Geschmack hatte?}
\qitem{Der Konkurrent der Sportlerin, der einen ungewöhnlichen Namen hatte, hat sich verletzt.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Sportlerin komisch hiess?}
...
\qitem{Die Pflegerin der Rentnerin, die eine aufdringliche Art hatte, hat letzten Monat geheiratet.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Pflegerin Leuten zu nahe kam?}
\qitem{Die Klassenlehrerin des Schülers, die mehrere langhaarige Hunde hatte, mag ausgefallene Brillen.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Klassenlehrerin Hunde hatte?}
...
\qitem{Der Optiker des Verkäufers, der eine schwerwiegende Depression hatte, wurde überfallen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Verkäufer depressiv war?}
...
\qitem{Der Agent der Sängerin, der einige silbergraue Strähnen hatte, wurde wegen Drogenbesitz festgenommen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Agent silbergraue Strähnen hatte?}
\qitem{Die Kollegin des Detektiven, der einen großen Hund hatte, hatte öfter Probleme mit dem Finanzamt.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Kollegin einen großen Hund hatte?}
\qitem{Der Steuerberater des Psychologen, der beschämend vernachlässigte Zähne hatte, hat eine Stauballergie.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Psycholog gelbe Zähne hatte?}
...
\qitem{Der Cousin der Schriftstellerin, die eine tragische Vergangenheit hatte, fährt einen BMW.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Cousin eine schlimme Vergangenheit hatte?}
\qitem{Die Friseuse der Regisseurin, die einen ausgezeichneten Ruf hatte, ist unbestimmt verzogen.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Friseuse respektiert wurde?}
\qitem{Der Mentor der Doktorandin, die zwei kleine Kinder hatte, war kurz vor dem Verzweifeln.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Doktorandin Kinder hatte?}
\qitem{Die Reisefüherin des Touristen, der eine dicke Hornbrille hatte, bekam ständig Anrufe.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Reisefüherin eine Brille trug?}
