...
\qitem{Die Steuerberaterin der Psychologin, die beschämend vernachlässigte Zähne hatte, hat eine Stauballergie.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Steuerberaterin gelbe Zähne hatte?}
\qitem{Die Cousine der Schriftstellerin, die eine tragische Vergangenheit hatte, fährt einen BMW.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Schriftstellerin eine schlimme Vergangenheit hatte?}
\qitem{Die Assistentin des Zahnarztes, der einen eigenwilligen Haarschnitt hatte, war sehr selbstbewußt.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Assistentin einen Irokesen hatte?}
...
\qitem{Die Agentin des Sängers, der einige silbergraue Strähnen hatte, wurde wegen Drogenbesitz festgenommen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Sänger silbergraue Strähnen hatte?}
\qitem{Die Retterin des Verunglückten, der eine schöne Wohnung hatte, bekam eine Auszeichnung.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Verunglückte eine helle Dachterassenwohnung hatte?}
...
\qitem{Der Arzt der Bäuerin, die weithin bekannte Vorfahren hatte, war sehr neugierig.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Arzt bekannte Vorfahren hatte?}
\qitem{Die Anwältin des Angeklagten, die kein bisschen Anstand hatte, hat sich verspätet.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Anwältin hämisch grinste?}
...
\qitem{Die Mentorin des Doktoranden, der zwei kleine Kinder hatte, war kurz vor dem Verzweifeln.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Mentorin Kinder hatte?}
...
\qitem{Die Konkurrentin des Sportlers, die einen ungewöhnlichen Namen hatte, hat sich verletzt.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Konkurrentin komisch hiess?}
\qitem{Die Pflegerin des Rentners, die eine aufdringliche Art hatte, hat letzten Monat geheiratet.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Rentner Leuten zu nahe kam?}
...
\qitem{Der Bruder der Schneiderin, der hübsche schwarze Locken hatte, hat sich verlobt.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Bruder lockige Haare hatte?}
...
\qitem{Der Buchhalter der Unternehmerin, die viel goldenen Schmuck hat, hat momentan Urlaub.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Unternehmerin viel Goldschmuck hat?}
\qitem{Die Sekretärin der Direktorin, die außergewöhnlich grosse Ohren hatte, überlegt sich zu kündigen.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Direktorin grosse Ohren hatte?}
\qitem{Der Freund der Tänzerin, die eine unheilbare Krankheit hatte, hört gerne Rockmusik.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Tänzerin schwer krank war?}
\qitem{Der Kollege des Detektiven, der einen großen Hund hatte, hatte öfter Probleme mit dem Finanzamt.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Detektiv einen großen Hund hatte?}
\qitem{Der Angestellte der Bäckerin, die regelmässig starke Hustenanfälle hat, überlegt zu kündigen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Angestellte oft hustet?}
\qitem{Die Schwägerin des Fotografen, die eine beeindruckende Privatbibliothek hatte, lebte in Wien.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Fotograf viele Bücher hatte?}
...
\qitem{Der Onkel der Kassiererin, der ein auffälliges Muttermal hatte, hat das Rauchen aufgegeben.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Onkel ein grosses Muttermal hatte?}
\qitem{Der Bedienstete der Gräfin, der extrem laute Kinder hatte, konnte nicht mehr.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Bedienstete Kinder hatte?}
\qitem{Die Optikerin der Verkäuferin, die eine schwerwiegende Depression hatte, wurde überfallen.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Optikerin depressiv war?}
\qitem{Die Tutorin der Studentin, die überschäumend gute Laune hatte, hatte die Regelstudienzeit schon langen überschritten.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Studentin gut gelaunt war?}
...
\qitem{Der Patient der Logopädin, der eine sportliche Figur hatte, spielte sehr gerne Klavier.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Logopädin muskulös war?}
\qitem{Der Verleger der Autorin, die einen österreichischen Akzent hatte, hat sich gemeldet.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Verleger wie ein Österreicher sprach?}
...
\qitem{Der Klassenlehrer der Schülerin, die mehrere langhaarige Hunde hatte, mag ausgefallene Brillen.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Schülerin Hunde hatte?}
...
\qitem{Der Visagist der Bürgermeisterin, der beeindruckend viel Ehrgeiz hatte, schrieb Gedichte.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Bürgermeisterin ehrgeizig war?}
\qitem{Der Sohn des Forschers, der schwere gesundheitliche Probleme hatte, spielte gerne Schach.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Sohn unter gesundheitlichen Problemen litt?}
\qitem{Die Trainerin des Athleten, der einen fürchterlichen Schnupfen hatte, verlangte immer maximale Leistung.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Trainerin einen Schnupfen hatte?}
\qitem{Die Schneiderin des Geschäftsmanns, der sehr schwarzen Humor hatte, lachte viel.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Geschäftsmann schwarzen Humor mochte?}
...
\qitem{Die Vertraute der Richterin, die viele gute Einfälle hatte, kannte viele Geheimnisse.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Vertraute kreativ war?}
...
\qitem{Der Schwiegersohn der Gitarristin, der einen ausgezeichneten Geschmack hatte, lachte eigentlich ständig.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Gitarristin einen guten Geschmack hatte?}
\qitem{Die Gärtnerin des Bankers, die andauernd heftige Migräne hatte, war nicht besonders gesprächig.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Gärtnerin Migräne hatte?}
...
\qitem{Der Berater des Politikers, der einen neuen Audi hatte, hat sich bewährt.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Berater einen neuen Audi hatte?}
\qitem{Der Reisefüher des Touristen, der eine dicke Hornbrille hatte, bekam ständig Anrufe.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Tourist eine Brille trug?}
\qitem{Der Manager des Künstlers, der kristallklare blaue Augen hat, ist noch recht unerfahren.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Künstler kristallklare blaue Augen hat?}
...
\qitem{Die Friseuse des Regisseurs, die einen ausgezeichneten Ruf hatte, ist unbestimmt verzogen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Regisseur respektiert wurde?}
...
\qitem{Der Stylist des Schauspielers, der große finanzielle Probleme hatte, trug eine Perücke.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Stylist Schulden hatte?}
