...
\qitem{Die Tante der Kassiererin, die ein auffälliges Muttermal hatte, hat das Rauchen aufgegeben.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Tante ein grosses Muttermal hatte?}
...
\qitem{Der Friseur des Regisseurs, der einen ausgezeichneten Ruf hatte, ist unbestimmt verzogen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Regisseur respektiert wurde?}
...
\qitem{Der Verleger der Autorin, der einen österreichischen Akzent hatte, hat sich gemeldet.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Verleger wie ein Österreicher sprach?}
...
\qitem{Der Konkurrent des Sportlers, der einen ungewöhnlichen Namen hatte, hat sich verletzt.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Konkurrent komisch hiess?}
...
\qitem{Die Schwester der Schneiderin, die hübsche schwarze Locken hatte, hat sich verlobt.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Schwester lockige Haare hatte?}
...
\qitem{Der Klassenlehrer der Schülerin, der mehrere langhaarige Hunde hatte, mag ausgefallene Brillen.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Schülerin Hunde hatte?}
\qitem{Die Cousine des Schriftstellers, der eine tragische Vergangenheit hatte, fährt einen BMW.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Schriftsteller eine schlimme Vergangenheit hatte?}
\qitem{Der Reisefüher der Touristin, die eine dicke Hornbrille hatte, bekam ständig Anrufe.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Touristin eine Brille trug?}
...
\qitem{Die Retterin des Verunglückten, die eine schöne Wohnung hatte, bekam eine Auszeichnung.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Verunglückte eine helle Dachterassenwohnung hatte?}
...
\qitem{Der Angestellte der Bäckerin, der regelmässig starke Hustenanfälle hat, überlegt zu kündigen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Angestellte oft hustet?}
\qitem{Der Manager der Künstlerin, die kristallklare blaue Augen hat, ist noch recht unerfahren.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Künstlerin kristallklare blaue Augen hat?}
\qitem{Die Optikerin des Verkäufers, der eine schwerwiegende Depression hatte, wurde überfallen.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Optikerin depressiv war?}
...
\qitem{Die Visagistin der Bürgermeisterin, die beeindruckend viel Ehrgeiz hatte, schrieb Gedichte.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Bürgermeisterin ehrgeizig war?}
\qitem{Der Schwager des Fotografen, der eine beeindruckende Privatbibliothek hatte, lebte in Wien.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Fotograf viele Bücher hatte?}
...
\qitem{Die Bedienstete der Gräfin, die extrem laute Kinder hatte, konnte nicht mehr.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Bedienstete Kinder hatte?}
\qitem{Der Freund der Tänzerin, der eine unheilbare Krankheit hatte, hört gerne Rockmusik.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Tänzerin schwer krank war?}
\qitem{Der Buchhalter der Unternehmerin, der viel goldenen Schmuck hat, hat momentan Urlaub.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Unternehmerin viel Goldschmuck hat?}
\qitem{Die Agentin des Sängers, die einige silbergraue Strähnen hatte, wurde wegen Drogenbesitz festgenommen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Sänger silbergraue Strähnen hatte?}
...
\qitem{Der Berater der Politikerin, die einen neuen Audi hatte, hat sich bewährt.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Berater einen neuen Audi hatte?}
...
\qitem{Der Pfleger des Rentners, der eine aufdringliche Art hatte, hat letzten Monat geheiratet.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Rentner Leuten zu nahe kam?}
\qitem{Die Assistentin des Zahnarztes, die einen eigenwilligen Haarschnitt hatte, war sehr selbstbewußt.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Assistentin einen Irokesen hatte?}
...
\qitem{Der Sohn der Forscherin, die schwere gesundheitliche Probleme hatte, spielte gerne Schach.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Sohn unter gesundheitlichen Problemen litt?}
...
\qitem{Die Vertraute des Richters, der viele gute Einfälle hatte, kannte viele Geheimnisse.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Vertraute kreativ war?}
\qitem{Die Steuerberaterin des Psychologen, der beschämend vernachlässigte Zähne hatte, hat eine Stauballergie.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Steuerberaterin gelbe Zähne hatte?}
\qitem{Die Trainerin des Athleten, die einen fürchterlichen Schnupfen hatte, verlangte immer maximale Leistung.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Trainerin einen Schnupfen hatte?}
...
\qitem{Der Anwalt des Angeklagten, der kein bisschen Anstand hatte, hat sich verspätet.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Anwalt hämisch grinste?}
\qitem{Der Gärtner des Bankers, der andauernd heftige Migräne hatte, war nicht besonders gesprächig.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Gärtner Migräne hatte?}
\qitem{Die Tutorin des Studenten, der überschäumend gute Laune hatte, hatte die Regelstudienzeit schon langen überschritten.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Student gut gelaunt war?}
\qitem{Die Patientin der Logopädin, die eine sportliche Figur hatte, spielte sehr gerne Klavier.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Logopädin muskulös war?}
...
\qitem{Der Kollege der Detektivin, die einen großen Hund hatte, hatte öfter Probleme mit dem Finanzamt.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Detektivin einen großen Hund hatte?}
\qitem{Die Schneiderin des Geschäftsmanns, die sehr schwarzen Humor hatte, lachte viel.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Geschäftsmann schwarzen Humor mochte?}
\qitem{Der Stylist der Schauspielerin, die große finanzielle Probleme hatte, trug eine Perücke.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Stylist Schulden hatte?}
\qitem{Die Schwiegertochter der Gitarristin, die einen ausgezeichneten Geschmack hatte, lachte eigentlich ständig.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Gitarristin einen guten Geschmack hatte?}
...
\qitem{Die Mentorin des Doktoranden, die zwei kleine Kinder hatte, war kurz vor dem Verzweifeln.}{Wurde hier gesagt oder möglicherweise gemeint, dass die Mentorin Kinder hatte?}
...
\qitem{Die Sekretärin des Direktors, der außergewöhnlich grosse Ohren hatte, überlegt sich zu kündigen.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Direktor grosse Ohren hatte?}
...
\qitem{Der Arzt der Bäuerin, der weithin bekannte Vorfahren hatte, war sehr neugierig.}{Wurde hier gesagt oder möglicherweise gemeint, dass der Arzt bekannte Vorfahren hatte?}
