...
set PressKey     "Dr�cken Sie eine beliebige Taste, um fortzufahren."
# The question key explanation:
set QuestionKeys "\"[string toupper $NoKey]\"  f�r NEIN.    \"[string toupper $YesKey]\"  f�r JA."
...
proc buildMainWindow {} {
  ...
  # requires wish8.5 - otherwise overridedirect has to be used (which causes a lot of trouble, like broken keyboard input)
...
proc stopMakingSenseReadingPresentSentence item {
  global Tag NumWords SkipKey StopTime ResultFile Subject Abort Word \
      ClockRes TextColor MaskColor ShowWords PlayWords WindowStep \
      StopMakingSense
 StopMakingSenseNoKey MakesSense
